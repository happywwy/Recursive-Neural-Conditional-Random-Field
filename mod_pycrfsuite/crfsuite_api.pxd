...
cdef extern from "trainer_wrapper.hpp" namespace "CRFSuiteWrapper":
    ...
    cdef cppclass Trainer:
        ...
        void clear() except +
        void modify(ItemSequence, int) except +
        void append(ItemSequence, StringList, int) except +
        bint select(string, string) except +
        #int train(string, int, double*, int, double*, int, double, double, int, int) except +
        int train(string, int, double*, double*, int, double, double, double*, int) except +
